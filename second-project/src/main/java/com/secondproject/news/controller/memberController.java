...
public class memberController {
	...
	public String signUpForm(Model model, Member m, String name,@RequestParam("userId")  String id, String pass, String phone1, String phone2, String phone3, String emailId, String emailDomain, @RequestParam("interest") String categoryId) {
